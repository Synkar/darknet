    ...
    float hier_thresh, int dont_show, int ext_output, int save_labels, char *outfile, int letter_box, int benchmark_layers)
{
    ...
    while (1) {
        ...
        draw_detections_v3(im, dets, nboxes, thresh, names, alphabet, l.classes, ext_output, 0);
    ...
    int letter_box, int benchmark_layers)
{
    ...
    while (1) {
        ...
        draw_detections_v3(sized, dets, nboxes, thresh, names, alphabet, l.classes, 1, 1);
